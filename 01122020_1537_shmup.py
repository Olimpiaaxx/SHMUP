...
meteor_images = []
meteor_list = ['meteorBrown_big2.png', 'meteorBrown_med1.png', 'meteorBrown_small1.png', 'meteorBrown_tiny2.png']
...
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'pew_pew.wav'))
shield_sound = pygame.mixer.Sound(path.join(snd_dir, 'Powerup6.wav'))
power_sound = pygame.mixer.Sound(path.join(snd_dir, 'Powerup12.wav'))
expl_sounds = []
...
while running:
    ...
    # check to see if player hit powerups
